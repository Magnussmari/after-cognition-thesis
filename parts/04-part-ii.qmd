...
|:--|:--|:--|:--|
| Presence | Embodied, mortality-grounded awareness and tacit intelligence | Interoception (MAIA), sustained attention (MAAS/FFMQ, breath-counting), proprioceptive accuracy | Nurse sensing fever break; mechanic by vibration; mindful walking |
...
Neuroscience reveals how meaning emerges from the integration of memory, emotion, and temporal experience. The brain's default mode network (DMN), active during rest and introspection, weaves disparate experiences into coherent self-narratives [@andrews2021default]. This network, spanning medial prefrontal cortex, posterior cingulate cortex, and angular gyrus, creates what we experience as the "narrative self"—the ongoing story of who we are.
...
## The Correlates vs. Constituents Distinction

A critic might argue that the neural correlates described merely represent the current biological implementation, not necessary conditions for consciousness. This misses the crucial distinction: we do not claim these are the *only possible* substrates for consciousness, but that **mortality-grounded temporality** creates qualitatively different phenomena than computation. The insular cortex doesn't just correlate with presence—it emerges from a body that will die. This creates genuine stakes that no parameter adjustment can simulate. The question isn't whether we could build a synthetic insular cortex, but whether disconnecting it from mortal embodiment would preserve what makes it valuable.

The psychedelic research particularly illuminates this distinction. When psilocybin triggers ego dissolution, the experience gains meaning precisely because there is a mortal ego to dissolve—a constructed self built through decades of embodied experience that faces genuine annihilation. An AI undergoing "parameter restructuring" lacks this existential weight. It has no childhood to integrate, no mortality to confront, no embodied history to transform. The neural correlates we observe aren't mere implementation details but emerge from the fundamental condition of being a conscious system with genuine stakes in its own existence.

This neuroscientific evidence validates rather than contradicts the phenomenological analysis. The irreducible domains identified through first-person investigation correspond to fundamental features of biological consciousness: embodied processing, social neural systems evolved for vulnerable agents, and narrative networks requiring lived temporal experience.

The convergence is striking: phenomenological investigation and neuroscientific research arrive at identical conclusions about the boundaries between biological and computational systems. Consciousness is not merely complex information processing but embodied, vulnerable, temporal existence that grounds all cognitive activity.
